...
public class SpeciesUpdater {
    private static final String nodePath = (System.getProperty("user.dir") + "/data/Especies.csv").replaceAll("\\\\", "/");
    private static final String relationPath = (System.getProperty("user.dir") + "/data/Cadena.csv").replaceAll("\\\\", "/");
    ...
    private static final File databaseDirectory = new File("C:/Users/cluadmin/.Neo4jDesktop/neo4jDatabases/database-5da26676-b4aa-464b-8c40-06cfa705dd20/installation-3.4.1/data/databases/graph.db");
